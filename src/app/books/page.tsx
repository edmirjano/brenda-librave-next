    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Librat</h1>
        ...
        <div className="lg:grid lg:grid-cols-4 lg:gap-8">
          ...
          <div className="hidden lg:block">
            <div className="sticky top-4">
              ...
              >
                <BookFilters searchParams={searchParams} isMobile={false} />
              </Suspense>
            </div>
          </div>
          ...
          <div className="lg:col-span-3">
            ...
            <div className="flex justify-between items-center mb-6 lg:hidden">
              <span className="text-sm text-gray-600">Të gjitha librat</span>
              <Suspense fallback={<div className="h-8 w-20 bg-gray-200 rounded animate-pulse" />}>
                <BookFilters searchParams={searchParams} isMobile={true} />
              </Suspense>
            </div>
...
export const metadata = {
  ...
  description:
    'Zbuloni koleksionin tonë të gjerë të librave shqiptarë dhe ndërkombëtarë. Gjeni librat tuaj të preferuar me çmime të përballueshme.',
